    ...
    <View style={styles.container}>
      ...
      <ScrollView style={styles.scrollView} contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.infoCard}>
          ...
          <View style={styles.infoRow}>
            <Ionicons name="people" size={20} color="#127067" />
            <View style={styles.infoTextContainer}>
              <Text style={styles.infoLabel}>Niños Transportados</Text>
              <Text style={styles.infoValue}>{viaje.cantidadNinos}</Text>
            </View>
          </View>
        </View>
        ...
        <View style={styles.pasajerosCard}>
          <Text style={styles.sectionTitle}>Detalle de Pasajeros</Text>
            ...
            <View key={index} style={styles.pasajeroItem}>
              <View style={styles.pasajeroHeader}>
                ...
                <View style={styles.pasajeroInfo}>
                  ...
                  <Text style={styles.pasajeroApoderado}>{pasajero.nombreApoderado}</Text>
                  {pasajero.direccion && (
